...
import com.run.running.view.worldmap.ImageSurfaceView;
import com.run.running.view.worldmap.RandomAccessFileInputStream;

import java.io.InputStream;

/**
 * Created by zsr on 2016/5/30.
 */
public class WorldMapActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSurfaceView = (ImageSurfaceView) findViewById(R.id.worldsurface);
