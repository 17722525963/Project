...
import com.run.running.utils.http_xutil.xutils.DownloadInfo;
import com.run.running.utils.http_xutil.xutils.DownloadManager;
import com.run.running.utils.http_xutil.xutils.DownloadState;
import com.run.running.utils.http_xutil.xutils.DownloadViewHolder;
 ...
 */
@ContentView(R.layout.activity_httpfromutildownload)
public class HttpFromXutilDownloadActivity extends BaseActivity {

    @ViewInject(R.id.http_xutil_list)
