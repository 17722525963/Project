package com.run.runlibrary.widget.floatingactionbutton;
...
/**
 * 自定义behavior
 * 需要重写两个方法：layoutDependsOn、onDependentViewChanged
 * 实现FloatingActionButton 点击后旋转90度
 * Created by zsr on 2016/4/7.
 */
